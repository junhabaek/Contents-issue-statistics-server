...
def get_season_character_cast(content_id: str, season_number: int)-> List:
    url = f"https://api.tmdb.org/3/tv/{content_id[1:]}/season/{season_number}/credits?api_key={_API_KEY}"
